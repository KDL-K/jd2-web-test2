...
<title>Insert title here</title>
    ...
    <fmt:message bundle="${loc}" key="local.lang_registration" var="l_registration"/>
...
<body>
    ...
    <form action="Controller" method="post">
      ...
      <c:out value="${l_age}"/> 
      <input type="number" name="age" min=1 value="1"/><br/>
      <c:out value="${l_role}"/> 
            <select name="role">
                <option>user</option>
                <option>admin</option>
      ...
      <input type="submit" value="${l_registration}"/>
    </form>
